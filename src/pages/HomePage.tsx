...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans">
      <header className="w-full h-auto min-h-[80px] md:h-24 bg-[#ff8200] border-b border-slate-200 flex flex-col sm:flex-row items-center justify-between px-6 md:px-8 py-4 sm:py-0 shadow-sm gap-4 transition-all">
        {/* Banner */}
